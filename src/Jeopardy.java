...
public class Jeopardy implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(buttonPressed == firstButton){
			...
			askQuestion("Video in which Michael Jackson plays a werewolf & a zombie", "Thriller", 200);
			...
			askQuestion("The scottish word for lake", "loch", 400);
		...
		// Clear the button text (set the button text to nothing)
			...
			askQuestion("The world's largest lake","The Caspian Sea", 600);
			thirdButton.setText(null);
		}
		else if(buttonPressed == fourthButton){
			askQuestion("She came from France to harbor America's freedom", "The Statue of Liberty", 800);
			fourthButton.setText(null);
		}
		else if(buttonPressed == fifthButton){
			askQuestion("After the deed, he leaped to the stage shouting 'Sic semper tyrannis'", "John Wilkes Booth", 1000);
